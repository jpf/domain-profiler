class Name
  def initialize
    @aliases = {
      ...
      :google => { :name => 'Google', :dba => ['aspmx.l.google.com', 'google.com', 'googlemail.com', 'l.google.com','google'] },
      :markmonitor => { :name => 'MarkMonitor', :dba => ['markmonitor inc.'] },
      :microsoft => { :name => 'Microsoft', :dba => ['msft.net'] },
      :netsol => { :name => 'Network Solutions', :dba => ['network solutions, llc.','network solutions llc'] },
